...
export default class EditFlagCard extends React.Component<any, any>{
  ...
  componentDidMount() {
    axios.get(process.env.API_ENDPOINT+'/country/' + this.props.match.params.id)
      .then(response => {
        this.setState({
  ...
  onSubmit(e) {
    ...
    axios.post(process.env.API_ENDPOINT+'/country/update/' + this.props.match.params.id, updatedCountryData)
      .then(res => {
